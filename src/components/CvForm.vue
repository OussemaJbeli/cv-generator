  ...
  data() {
    return {
      formData: {
        ...
        contacts: [
          { icon: 'fas fa-map-signs', data: '21 Street, Texas, USA' },
          { icon: 'fas fa-mobile-alt', data: '+324 4445678' },
          { icon: 'fas fa-envelope', data: 'stephen@gmail.com' },
          { icon: 'fab fa-weebly', data: 'www.stephen.com' },
        ],
        skillsTitle: "Skills",
        skills: [
          { name: 'HTML', level: 80 },
        ...
        socialTitle: 'Social',
        socialLinks: [
          { icon: 'fab fa-facebook-square', platform: 'Facebook', handle: 'Stephen@facebook' },
          { icon: 'fab fa-twitter-square', platform: 'Twitter', handle: 'Stephen@twitter' },
          { icon: 'fab fa-youtube', platform: 'Youtube', handle: 'Stephen@youtube' },
          { icon: 'fab fa-linkedin', platform: 'LinkedIn', handle: 'Stephen@linkedin' },
        ],
        aboutTitle: 'About Us',
        aboutText: 'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perspiciatis illo fugit officiis distinctio culpa officia totam atque exercitationem inventore repudiandae?',
        workTitle: 'Work Experience',
        workExperience: [
          { date: '2013 - 2015', position: 'Lorem ipsum dolor sit amet.', description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum, voluptatibus!' },
          { date: '2015 - 2017', position: 'Lorem ipsum dolor sit amet.', description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum, voluptatibus!' },
          { date: '2017 - Present', position: 'Lorem ipsum dolor sit amet.', description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum, voluptatibus!' },
        ],
        educationTitle: 'Education',
        education: [
          { date: '2010 - 2013', degree: 'Web Designing (Texas University)', description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum, voluptatibus!' },
          { date: '2000 - 2010', degree: 'Texas International School', description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum, voluptatibus!' },
        ],
        hobbyTitle: 'Hobby',
        hobbies: [
          { icon: 'fas fa-book' },
